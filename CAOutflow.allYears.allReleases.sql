...
-- philippeg 10apr2014
--
select to_char(changegroup.created, 'YYYY'),to_char(changegroup.created, 'WW'),concat(project.pkey,'-',jiraissue.issuenum),changegroup.author,projectversion.vname
from  jiraissue,project,changeitem,changegroup,nodeassociation,projectversion
